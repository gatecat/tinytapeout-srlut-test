...
set ::env(DESIGN_NAME) scan_wrapper_341353777861755476
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341353777861755476.v \
$::env(DESIGN_DIR)/scan_wrapper_341353777861755476.v"
